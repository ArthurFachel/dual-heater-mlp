...
Documento relacionado: [`qwen_iso_plasticity_ablation.md`](../protocols/qwen_iso_plasticity_ablation.md),
...
`docs/results/bert_slowheat_diagnostic_results.md` registra que o SlowHeat em BERT
