...
[functional_slowheat.md](../mechanisms/functional_slowheat.md); o texto do paper está em
...
[results_provenance_status.md](../audits/results_provenance_status.md), item P1.
...
completo estão em [confirmatory_protocol.md](../protocols/confirmatory_protocol.md).
...
[split_mnist_experiment_log.md](../results/split_mnist_experiment_log.md).
O protocolo pareado de 4 pares está em
[dualheat_paired_protocol.md](../protocols/dualheat_paired_protocol.md).
O piloto sintético de 3 seeds, que **precede a implementação atual** e não é
evidência, está em [synthetic_ablation_pilot.md](../results/synthetic_ablation_pilot.md).
