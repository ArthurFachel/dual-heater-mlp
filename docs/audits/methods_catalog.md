...
`dualheat_global_topk`. Resultados históricos: [bert_slowheat_diagnostic_results.md, Parte II](../results/bert_slowheat_diagnostic_results.md).
...
completo: [bert_full_coverage_ablation.md](../results/bert_full_coverage_ablation.md).
