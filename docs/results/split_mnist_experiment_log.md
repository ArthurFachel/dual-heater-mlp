...
A suíte atual contém mais de 100 testes automatizados. Entre
...
> [`confirmatory_protocol.md`](../protocols/confirmatory_protocol.md).
...
[`confirmatory_protocol.md`](../protocols/confirmatory_protocol.md): +0,869 p.p. no endpoint
