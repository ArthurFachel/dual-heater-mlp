...
**Protocolo congelado:** [`hard_vs_soft_protection.md`](../protocols/hard_vs_soft_protection.md) e
...
- `docs/architectures/arch_cnn.md` e `docs/architectures/arch_mlp.md`: passam a ter resultado válido de
  proteção hard pós-correção de eval-mode. Os quatro agregados antigos com
  `hard_freeze` continuam não citáveis.
- `docs/architectures/arch_bert.md` e `article/manuscript.md`: o ganho do BERT não pode mais
