...
Resultado e ressalvas em [`confirmatory_protocol.md`](../protocols/confirmatory_protocol.md).
...
[`project_methods_and_results.md`](../audits/project_methods_and_results.md).
...
Contrato em [`split_cifar.md`](../protocols/split_cifar.md).
...
em [`hard_vs_soft_protection.md`](../protocols/hard_vs_soft_protection.md), resultados em
