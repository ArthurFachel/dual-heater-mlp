...
commit `6f4d12d`. Resultados e leitura em **`docs/results/hard_vs_soft_results.md`**.
...
Executado. Ver `docs/results/hard_vs_soft_results.md`. O caminho 3 foi o que ocorreu:
hard não venceu soft em nenhum alvo, e perdeu com significância onde a
capacidade aperta. Falta atualizar `docs/architectures/arch_mlp.md`, `docs/architectures/arch_cnn.md`,
`docs/architectures/arch_bert.md` e o manuscrito.
...
4. Em qualquer caso, escrever a seção e atualizar `docs/architectures/arch_mlp.md`,
   `docs/architectures/arch_cnn.md` e `docs/architectures/arch_bert.md`.
