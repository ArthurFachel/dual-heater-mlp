...
[bert_full_coverage_ablation.md](../results/bert_full_coverage_ablation.md). SwiGLU foi
implementado no host Qwen2 (Etapa E concluída; ver
[functional_slowheat_qwen.md](../architectures/functional_slowheat_qwen.md)). QKV fundido, GQA,
...
[bert_slowheat_diagnostic_results.md, Parte II](../results/bert_slowheat_diagnostic_results.md). Elas são evidência
...
Consulte [bert_full_coverage_ablation.md](../results/bert_full_coverage_ablation.md) para a
...
- [Catálogo atual de métodos](../audits/methods_catalog.md)
- [Ablação de cobertura completa BERT](../results/bert_full_coverage_ablation.md)
- [Resultados BERT/CLINC150, diagnóstico e runs históricas](../results/bert_slowheat_diagnostic_results.md)
